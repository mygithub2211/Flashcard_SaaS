...
Link: https://flashcard-saas-phi.vercel.app/

Description:
1) The app will generate Flashcard Set based on the topic entered by the user, using LLMs powered by GPT-4o-mini
2) The user needs to log into the app first. This will done through Clerk API
